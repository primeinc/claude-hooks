...
function writeLine(level, subsystem, msg, data) {
  ...
  // stderr must stay clean — hook runners may interpret stray stderr as errors.
  // Log output goes to file only. Use CLAUDE_HOOKS_DEBUG=1 for stderr (manual debugging only).
  if (debugToStderr) {
